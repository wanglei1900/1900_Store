<template>
	<div>
		<div class="header">
			<image @click='toLogin' class="userImg" :src="userInfo.nickName ? userInfo.avatarUrl : '../../static/images/personal/personal.png'"></image>
			<div class='userInfo' >
				<p v-if="userInfo.nickName">{{userInfo.nickName}},欢迎您</p>
				<p v-else>未登录</p>
			</div>
		</div>
